      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row gap-x-10">
          ...
          pb-24 p-6 items-start">
            ...
            />
            <textarea className="bg-transparent border-b py-12 resize-none mb-12 outlone-none w-full placeholder:text-white focus:border-accent transition-all" placeholder="Your message"></textarea>
