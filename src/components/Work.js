        ...
        <div className="flex flex-col lg:flex-row gap-x-10">
          ...
          className="flex-1 flex flex-col gap-y-12 mb-10 lg:mb-0">
            <div>
              ...
              <p>lorem rdfd rtrtr fdfgg fff. dfdffd dfdfdfd fdfdfd fdfdfdf ddfdfdfd 
                fdfer dfdftr dfdvfgfg fdfrtrt ddgfgtrt frytytr.</p>
            ...
            >
              ...
              duration-500 z-50"
              >
                <span className="text-gradient">Pet Care Smart System</span>
              </div>
          ...
          className="flex-1 flex flex-col gap-y-10">
            ...
            >
              ...
              duration-500 z-50"
              >
                <span className="text-gradient">Web Search Engine</span>
              </div>
              {/* <div className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all 
              duration-500 z-50'>Web Search Engine</div>
              <div className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all 
            ...
            >
              ...
              duration-500 z-50"
              >
                <span className="text-gradient">Amazon Clone Web Application</span>
              </div>
              {/* <div className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all 
              duration-500 z-50'>Web Search Engine</div>
              <div className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all 
